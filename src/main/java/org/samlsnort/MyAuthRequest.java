...
public class MyAuthRequest extends RequestAbstractTypeImpl implements AuthnRequest {
    ...
    public MyAuthRequest(String namespaceURI, String elementLocalName, String namespacePrefix) {
